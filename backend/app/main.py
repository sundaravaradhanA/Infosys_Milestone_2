...
from app.routes import auth, accounts, transactions, budgets, bills, bills_fixed, rewards, alerts, insights, categories, export, users
...
app.include_router(bills_fixed.router, prefix="/api/bills_fixed", tags=["Bills Fixed"])
